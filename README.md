...
```bash
docker run -ti -p 8090:8090 -p 8091:8091 streacs/atlassian-confluence:x.x.x
```
...
Modify JVM memory
```bash
docker run -ti -p 8090:8090 -p 8091:8091 -e JVM_MEMORY_MIN=1024m -e JVM_MEMORY_MAX=2048m streacs/atlassian-confluence:x.x.x
```

Persist application data
```bash
docker run -ti -p 8090:8090 -p 8091:8091 -v CONFLUENCE-DATA:/var/opt/atlassian/application-data/confluence streacs/atlassian-confluence:x.x.x
```
